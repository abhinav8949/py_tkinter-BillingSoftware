...
class Bill_App:
    def __init__(self,root):
        self.root=root
        self.root.geometry("1275x780+0+0")
        self.root.minsize(1150,370)
        self.root.title("Simple Billing Software--Created By:@Code-Gamer")
        ...
        font=("times new roman", 12, "bold"),fg="white",
        bg=bg_color2)
        f6.place(x=2,y=360,relwidth=1, height=140)
        ...
        btn_frame.place(x=550,width=700,height=270)
...
#####################----Backend Function Logic----
    ...
    def save_bill(self):
        ...
        if op>0:
                ...
                f1=open("py_tkinter-BillingSoftware/customerbill/"+str(self.cbill.get())+".txt", "w")
    ...
    def search_saved_bill(self):
            ...
            for i in os.listdir("bills/"):
                 if i.split('.')[0]==self.search_bill.get():
                        f1=open(f"py_tkinter-BillingSoftware/customerbill/{i}", "r")
                        self.textarea.delete('1.0', END)
                        for d in f1:
    ...
    def calc_wind(self):  
        ...
        call(["py_tkinter-BillingSoftware", "calcu.py"])
        self.top.mainloop()
